...
from blender_relief.process import ProcessResult, reproject_bbox, process_dem
...
def _make_dem_tif(path: str, width=100, height=100,
                  west=10.0, north=46.0, dx=0.01, dy=-0.01,
                  epsg=4326, fill_value=32768):
...
def test_process_dem_no_crs(tmp_path):
    ...
    _make_dem_tif(dem_path, width=100, height=100,
                  west=10.0, north=46.0, dx=0.01, dy=-0.01)
